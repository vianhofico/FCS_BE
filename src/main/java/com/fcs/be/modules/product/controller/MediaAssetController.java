...
public class MediaAssetController {
    ...
    public ResponseEntity<ApiResponse<List<UploadMediaResponse>>> uploadImages(
        @RequestParam("files") List<MultipartFile> files
    ) {
        return ResponseEntity.ok(ApiResponse.ok("Images uploaded", mediaAssetService.uploadImages(files)));
    }
